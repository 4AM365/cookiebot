"""Shared helpers for the cookiebot RAG preprocessing pipeline.
...
# flags how central a book is to cookies specifically — carried into chunk
# metadata so the retriever can weight pastry/sugar/fat science over, say, the
# chapter on distilled spirits or cured meats.
...
BOOKS: list[Book] = [
    Book(
        ...
        relevance="general",
        note="Bread-focused, but the flour/gluten/leavening/fat fundamentals "
             "transfer to cookie doughs. Filtered to the relevant chapters.",
    ),
    Book(
        ...
        relevance="high",
        note="Sugars, Maillard/caramel browning, butter & fats, eggs, and the "
             "cookies/cakes/batters sections are the cookie core.",
    ),
    Book(
        ...
        relevance="core",
        note="Italian. The academic pastry reference: pasta frolla, biscotti, "
             "sugars, leavening agents, butter & fats — cookie science end to end.",
    ),
]
